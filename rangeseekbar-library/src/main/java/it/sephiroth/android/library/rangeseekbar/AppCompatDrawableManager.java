...
import static it.sephiroth.android.library.rangeseekbar.ThemeUtils.getDisabledThemeAttrColor;
import static it.sephiroth.android.library.rangeseekbar.ThemeUtils.getThemeAttrColor;
import static it.sephiroth.android.library.rangeseekbar.ThemeUtils.getThemeAttrColorStateList;
...
public final class AppCompatDrawableManager {
    ...
    private Drawable createDrawableIfNeeded(
    ...
    private boolean addDrawableToCache(
        @NonNull final Context context, final long key,
    ...
    static boolean tintDrawableUsingColorFilter(
        @NonNull Context context,
    ...
    private ColorStateList createDefaultButtonColorStateList(
        @NonNull Context context,
        @Nullable ColorStateList customTint) {
    ...
    private static class VdcInflateDelegate implements InflateDelegate {
        ...
        @Override
        public Drawable createFromXmlInner(
            @NonNull Context context, @NonNull XmlPullParser parser,
            @NonNull AttributeSet attrs, @Nullable Resources.Theme theme) {
            try {
